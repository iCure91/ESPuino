// clang-format off
	...
	*/
    ...
    #define BUTTON_MULTI_12   CMD_TOGGLE_BLUETOOTH_SINK_MODE
	...
	constexpr const char accessPointNetworkPassword[] = "espuino123";        // Access-point's Password, at least 8 characters! Set to an empty string to spawn an open WiFi.
